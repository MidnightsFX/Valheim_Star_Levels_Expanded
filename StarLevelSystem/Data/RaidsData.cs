            ...
            Raids = new List<RaidDefinition>()
            {
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        ...
                        new RaidSpawnEntry() { PrefabName = "Neck",    MaxSpawned = 10, SpawnInterval = 6f, SpawnChance = 100f, LevelMin = 1, LevelMax = 5, CreatureAI = AI.Alerted },
                        new RaidSpawnEntry() { PrefabName = "Boar",    MaxSpawned = 10, SpawnInterval = 6f, SpawnChance = 100f, LevelMin = 1, LevelMax = 5, CreatureAI = AI.Alerted },
                    },
                }},
                { new RaidDefinition() {
                    Name = "foresttrolls",
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        new RaidSpawnEntry() { PrefabName = "Troll", MaxSpawned = 9, SpawnInterval = 30f, SpawnChance = 100f, LevelMin = 1, LevelMax = 3, CreatureAI = AI.AgitatedByBuild, SpawnGroupSize = 2, 
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        ...
                        new RaidSpawnEntry() { PrefabName = "Greydwarf_Elite",  MaxSpawned = 6, SpawnInterval = 8f, SpawnChance = 100f, LevelMin = 1, LevelMax = 5, CreatureAI = AI.AgitatedByBuild },
                        new RaidSpawnEntry() { PrefabName = "Greydwarf_Shaman", MaxSpawned = 4, SpawnInterval = 8f, SpawnChance = 100f, LevelMin = 1, LevelMax = 5, CreatureAI = AI.Alerted },
                    },
                }},
                { new RaidDefinition() {
                    Name = "skeletons",
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        new RaidSpawnEntry() { PrefabName = "Skeleton",        MaxSpawned = 20, SpawnInterval = 4f, SpawnChance = 100f, UseRaidLevelSystem = false, CreatureAI = AI.Alerted, SpawnGroupSize = 3 },
                        new RaidSpawnEntry() { PrefabName = "Skeleton_Poison", MaxSpawned = 8, SpawnInterval = 6f, SpawnChance = 100f, UseRaidLevelSystem = false, CreatureAI = AI.Alerted },
                    },
                }},
                { new RaidDefinition() {
                    Name = "blobs",
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        new RaidSpawnEntry() { PrefabName = "Ghost", MaxSpawned = 12, SpawnInterval = 30f, SpawnChance = 100f, LevelMin = 1, LevelMax = 16, CreatureAI = AI.AgitatedByBuild },
                        new RaidSpawnEntry() { PrefabName = "Wraith", MaxSpawned = 12, SpawnInterval = 30f, SpawnChance = 100f, LevelMin = 1, LevelMax = 16, CreatureAI = AI.AgitatedByBuild },
                    },
                }},
                { new RaidDefinition() {
                    Name = "surtlings",
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        new RaidSpawnEntry() { PrefabName = "Skeleton",      MaxSpawned = 30, SpawnInterval = 4f, SpawnChance = 100f, LevelMin = 1, LevelMax = 12, CreatureAI = AI.Alerted, SpawnGroupSize = 2 },
                        new RaidSpawnEntry() { PrefabName = "Blob",          MaxSpawned = 10, SpawnInterval = 6f, SpawnChance = 100f, LevelMin = 1, LevelMax = 12, CreatureAI = AI.Alerted },
                        new RaidSpawnEntry() { PrefabName = "Draugr",        MaxSpawned = 12, SpawnInterval = 6f, SpawnChance = 100f, LevelMin = 1, LevelMax = 12, CreatureAI = AI.AgitatedByBuild, SpawnGroupSize = 2 },
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        ...
                        new RaidSpawnEntry() { PrefabName = "Fenring_Cultist",  MaxSpawned = 6, SpawnInterval = 12f, SpawnChance = 100f, LevelMin = 1, LevelMax = 16, CreatureAI = AI.AgitatedByBuild },
                    },
                }},
                { new RaidDefinition() {
                    Name = "army_goblin",
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        ...
                        new RaidSpawnEntry() { PrefabName = "GoblinShaman",  MaxSpawned = 4, SpawnInterval = 10f, SpawnChance = 100f, LevelMin = 1, LevelMax = 20, CreatureAI = AI.Alerted },
                        new RaidSpawnEntry() { PrefabName = "GoblinBrute",   MaxSpawned = 2, SpawnInterval = 12f, SpawnChance = 100f, LevelMin = 1, LevelMax = 20, CreatureAI = AI.AgitatedByBuild },
                    },
                }},
                { new RaidDefinition() {
                    Name = "bats",
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        new RaidSpawnEntry() { PrefabName = "Gjall",  MaxSpawned = 4, SpawnInterval = 12f, SpawnChance = 100f, LevelMin = 1, LevelMax = 26, CreatureAI = AI.AgitatedByBuild },
                ...
                { new RaidDefinition() {
                    ...
                    Spawns = new List<RaidSpawnEntry>() {
                        ...
                        new RaidSpawnEntry() { PrefabName = "SeekerBrute",  MaxSpawned = 2, SpawnInterval = 12f, SpawnChance = 100f, LevelMin = 1, LevelMax = 26, CreatureAI = AI.AgitatedByBuild },
